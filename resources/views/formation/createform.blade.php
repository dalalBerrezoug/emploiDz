    ...
    {{csrf_field()}}
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-8">
                            <input class="form-control" type="text" value="Artisanal kale" id="example-text-input" name="domaine">
                          </div>
                        </div>
                        <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-5">
                          <input class="form-control" type="date" value="2011-08-19" id="example-date-input" name="deb">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-5">
                            <input class="form-control" type="date" value="2011-08-19" id="example-date-input" name="fin">
                          </div>
                          <div class="col-lg-2"><input type="submit" name = "" value="Enregister"></form></div>
                        </div>
